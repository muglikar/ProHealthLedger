                    ...
                    >
                      ...
                      <td className="audit-col-share">
                        {(() => {
                          ...
                          const isMySubmission = isSignedIn && (
                          ...
                          return (
                            <button
                              ...
                              title={isAboutMe || (isAdmin && isAboutAdmin) ? "Share your vouch on LinkedIn" : "Share this vouch on LinkedIn"}
                              onClick={() => setShareModalData({ ...v, _firstPerson: isAboutMe || (isAdmin && isAboutAdmin) })}
                            >
