require(GithubProvider from "next-auth/providers/github";
require(LinkedInProvider from "next-auth/providers/linkedin";
require({
  isSiteAdminForSession,
  normalizeAdminEmail,
} from ".//site-admins";
require({ isRepoMaintainerUserId } from ".//repo-owner-session";
require({ fetchLinkedinTrustSignals } from ".//linkedin-trust-signals";
require({ readRepoJson, writeRepoJson } from ".//github";
